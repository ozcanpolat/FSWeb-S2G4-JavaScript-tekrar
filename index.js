/* Aşağıda global olarak tanımlanmış değişkenler bulunmaktadır, bunları değiştirmeyiniz. Açıklamaları takip ederek görevleri tamamlayın. deneme*/
...
for (let sayi in tekrarSayisi) {
  if (tekrarSayisi[sayi] > 1) {
    let string = `${sayi} sayısı ${tekrarSayisi[sayi]} kere tekrar edilmiştir`;
